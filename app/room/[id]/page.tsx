...
export default function RoomPage() {
  ...
  return (
    <div className="h-screen bg-white flex flex-col overflow-hidden">
      <header className="bg-[#4B2E2E] text-white p-4 flex-shrink-0">
              ...
              <div className="flex items-center gap-2">
                {isEditingName ? (
                  <Input
                    ...
                    className="h-6 text-xs bg-white text-black px-2 w-32"
                    autoFocus
                  />
                ) : (
                  <button
      ...
      <div className="flex-1 max-w-7xl mx-auto p-4 overflow-hidden">
